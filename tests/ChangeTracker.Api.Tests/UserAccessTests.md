...
| User                    | Email                                      | ApiKey     |
| ----------------------- | ------------------------------------------ | ---------- |
| t_ua_account_01_user_01 | t_ua_account_01_user_01@change-tracker.com | acc01usr01 |
| t_ua_account_01_user_02 | t_ua_account_01_user_02@change-tracker.com | acc01usr02 |
| t_ua_account_02_user_01 | t_ua_account_02_user_01@change-tracker.com | acc02usr01 |
| t_ua_account_02_user_02 | t_ua_account_02_user_02@change-tracker.com | acc02usr02 |
| t_ua_account_02_user_03 | t_ua_account_02_user_03@change-tracker.com | acc02usr03 |
...
values ('7aa9004b-ed6f-4862-8307-579030c860be',
        't_ua_account_01_user_02@change-tracker.com',
...
values ('146929d6-ee37-4298-8ce2-53e44494a089',
        't_ua_account_02_user_01@change-tracker.com',
...
values ('79630f70-3448-41d2-929c-f8d12cf7c43a',
        't_ua_account_02_user_02@change-tracker.com',
...
values ('ff1dc8c5-7064-431d-9ab5-e1427cde2bb7',
        't_ua_account_02_user_03@change-tracker.com',
...
insert into api_key values ('240e12b8-f5c4-4c53-807b-3a991c7f1b55',
                            (select id from "user" where email = 't_ua_account_01_user_02@change-tracker.com'),
                            'acc01usr02', to_timestamp('31.12.9999', 'DD.MM.YYYY'), null, now())
                            on conflict (id) do nothing ;

insert into api_key values ('818a0dae-0797-4fbd-a673-857ef67b1678',
                            (select id from "user" where email = 't_ua_account_02_user_01@change-tracker.com'),
