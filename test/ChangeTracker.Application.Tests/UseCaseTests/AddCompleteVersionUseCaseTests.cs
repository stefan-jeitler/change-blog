...
{
    public class AddCompleteVersionUseCaseTests
    {
        ...
        public AddCompleteVersionUseCaseTests()
        {
        ...
        public async Task ReleaseNewVersion_ValidVersion_Successful()
        {
            ...
            var releaseNewVersionUseCase = new AddCompleteVersionUseCase(_projectDaoStub, _versionDaoStub,
        ...
        public async Task ReleaseNewVersion_ValidVersion_PositionsProperlySet()
        {
            ...
            {
                _changeLogDaoStub.ChangeLogs[i].Position.Should().Be(uint.Parse(lineDto.Text));
            }
        }
