...
{
    public class AddVersionUseCase : IAddVersionUseCase
    {
        private readonly IProjectDao _projectDao;
        private readonly IUnitOfWork _unitOfWork;
        private readonly IVersionDao _versionDao;

        public AddVersionUseCase(IVersionDao versionDao, IProjectDao projectDao, IUnitOfWork unitOfWork)
        {
        ...
        public async Task ExecuteAsync(IAddVersionOutputPort output, VersionDto versionDto)
        {
