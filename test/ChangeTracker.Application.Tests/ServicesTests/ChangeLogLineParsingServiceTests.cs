...
namespace ChangeTracker.Application.Tests.ServicesTests
{
    public class ChangeLogLineParsingServiceTests
    {
        ...
        public async Task ParseChangeLogLine_ValidIssues_ReturnsIssuesAndNoOutput()
        {
            ...
            var changeLogLineDto = new ChangeLogLineParsingDto(TestAccount.Project.Id,
                null, text, Array.Empty<string>(), issues, 0);

            // act
            var parseLine = await service.ParseAsync(_outputPortMock.Object, changeLogLineDto);
        ...
        public async Task ParseChangeLogLine_InvalidLineText_InvalidChangeLogLineOutput()
        {
            ...
            // act
            var parsedLine = await service.ParseAsync(_outputPortMock.Object, changeLogLineDto);
