...
namespace ChangeBlog.Application.Tests.UseCaseTests.Versions.AssignPendingLineToVersion;
...
public class VersionAssignmentRequestModelTests
{
    ...
    {
        return new VersionAssignmentRequestModel(_testProductId, _testVersion, _testLineId);
    }
