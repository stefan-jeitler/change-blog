...
namespace ChangeTracker.Application.Tests.UseCaseTests
{
    public class AddProjectUseCaseTests
    {
        ...
        public async Task CreateProject_Successful()
        {
            ...
            var createProjectUseCase = new AddProjectUseCase(_accountDaoStub,
        ...
        public async Task CreateProject_ConflictWhenSaving_ConflictOutput()
        {
            ...
            var createProjectUseCase = new AddProjectUseCase(_accountDaoStub, _versioningSchemeDaoStub,
